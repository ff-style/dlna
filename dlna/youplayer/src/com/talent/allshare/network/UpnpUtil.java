...
//		}
	...
	public final static String DLNA_OBJECTCLASS_CONTAINER = "object.container";
	...
	//temp add 
	public final static String DLNA_OBJECTCLASS_FILEID = "object.item.textItem";
	
	public static boolean isNULLItem(Item item){
		String objectClass = item.getObjectClass();
		if (objectClass != null &&  objectClass.contains(DLNA_OBJECTCLASS_CONTAINER))
		{
			return true;
		}		
		return false;
	...
	public static boolean isPictureItem(Item item){
   	...
   	public static boolean isFileItem(Item item){
		String objectClass = item.getObjectClass();
		if (objectClass != null && objectClass.contains(DLNA_OBJECTCLASS_FILEID))
		{
			return true;
		}		
		return false;
