...
public class PullToUpdataListView extends ListView implements OnScrollListener {
	...
	private View mFooterLoaded;
	private OnMoreListener mOnMoreListener;
	private boolean mMoreEnable;
	private boolean isMoreLoading;
	private Adapter mAdapter;

	public PullToUpdataListView(Context context) {
		super(context);
		init(context);
	}

	public PullToUpdataListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context) {
		...
		mListViewFooter = inflater.inflate(R.layout.footer_more, null);
		mListViewFooter.setOnClickListener(new OnClickMoreListener());
		mFooterLoading = mListViewFooter.findViewById(R.id.loading);
		mFooterLoaded = mListViewFooter.findViewById(R.id.loaded);
		mMoreEnable = true;
	...
	public void onRefreshComplete() {
		state = DONE;
		lastUpdatedTextView.setText(getContext().getResources().getString(R.string.last_updated) + new Date().toLocaleString());
		changeHeaderViewByState();
	}
	...
	public void onMoreComplete() {
		...
		mFooterLoaded.setVisibility(View.VISIBLE);
	}

	private class OnClickMoreListener implements OnClickListener {
		...
		public void onClick(View v) {
			if (!isMoreLoading) {
				...
				mFooterLoaded.setVisibility(View.GONE);
	...
	public void setMoreEnable(boolean footerEnable) {
		mMoreEnable = footerEnable;
		if (mAdapter != null)
			removeFooterView(mListViewFooter);
		if (mMoreEnable) {
			addFooterView(mListViewFooter);
	...
	public void setMoreViewVisible(boolean flag){
		if(flag){
